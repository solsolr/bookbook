...
<body>
	...
	<br><br>
		...
		<input type="button" value="공지사항 등록"
			onclick="location.href='NoticeServlet?command=notice_write_form'" style="width:15%;line-height:30px;background-color:#6667ab;border:0;color:white;font-weight:700;font-size:18px;">
		<input type="button" value="공지사항 수정"
			onclick="open_win('NoticeServlet?command=notice_check_pass_form&num=${notice.num}', 'update')" style="width:15%;line-height:30px;background-color:#6667ab;border:0;color:white;font-weight:700;font-size:18px;">
		<input type="button" value="공지사항 삭제"
			onclick="open_win('NoticeServlet?command=notice_check_pass_form&num=${notice.num}', 'delete')" style="width:15%;line-height:30px;background-color:#6667ab;border:0;color:white;font-weight:700;font-size:18px;">
		<% } %>
