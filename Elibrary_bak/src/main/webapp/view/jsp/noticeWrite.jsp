...
<body>
			...
			<ul>
				<li><div class="dropdown">
						...
						<div class="dropdown-content">
						    ...
						    <a href="MemberServlet?command=mypage2&userid=<%=userid %>&nname=<%=nname %>">내 서재</a>
						    <a href="#">관심사</a>
						</div>
					</div>
				</li>
	...
	<h3 class="title_1">>공지사항 등록</h3>
	<br><br>
		<%
			String nname = "";
			if((String)session.getAttribute("nname")!=null) {
				nname = (String)session.getAttribute("nname");
			} else {
				nname = "admin";
			}
		%>
	<div id="wrap" align="center">
		<form name="frm" method="post" action="NoticeServlet">
			...
			<table>
				<tr>
					<th>작성자</th>
					<td><input type="text" name="nname" value="<%=nname %>" readonly></td>
				</tr>
				<tr>
					<th>비밀번호</th>
